  ...
  return (
    ...
    <form onSubmit={HendlSubmit}>
            <div className="list-group-item list-group-item-action" >
              <label >Name : </label>
              <input type="text" placeholder="Enter Name" name="name" value={input.name} onChange={HendleChange}/>
            </div>
            <div className="list-group-item list-group-item-action " >
              <label >Email  :</label>
              <input type="email" placeholder="Enter Email" name="email" value={input.email} onChange={HendleChange}/>
            </div>
      ...
      <div className="container mt-4 ">
        {
           ...
           <button className="btn btn-info btn-sm "onClick={()=>HendelEdit(i)} >Edit</button>
           <button className="btn btn-danger btn-sm mx-2" onClick={()=>HendleDelete(i)}>Delete</button>
            </div>
        </div>
                );
            })
